...
const LeaveManagement = () => {
  ...
  const fetchLeaves = async () => {
    try {
      ...
      const filteredLeaves = data.filter(leave => ['pending', 'forwarded'].includes(leave.status.toLowerCase()));
...
//   const fetchLeaves = async () => {
//     try {
//       const response = await axios.get('http://localhost:7000/leaves/my-leaves');
//       const filteredLeaves = response.data.filter(leave => ['pending', 'forwarded'].includes(leave.status.toLowerCase()));
//       setLeaves(filteredLeaves);
//       // setLeaves(response.data);
//     } catch (err) {
//       toast.error(err.response?.data?.message || 'Failed to fetch leaves');
...
//   const fetchLeaveBalance = async () => {
//     try {
//       const response = await axios.get('http://localhost:7000/leaves/balance');
...
//     try {
//       await axios.post('http://localhost:7000/leaves/apply', formData);
//       toast.success('Leave applied successfully');
//       setShowApplyForm(false);
//       setFormData({
//         startDate: '',
...
//   const handleCancel = async (leaveId) => {
//     try {
//       await axios.post(`http://localhost:7000/leaves/${leaveId}/cancel`);
//       toast.success('Leave cancelled successfully');
//       fetchLeaves();
//     } catch (err) {
//       toast.error(err.response?.data?.message || 'Failed to cancel leave');
...
//         <div className="px-4 py-4 sm:px-0">
//           <div className="flex justify-between items-center mb-6">
//             <h1 className="text-3xl font-bold text-gray-900">My Leave Requests Awaiting Approval</h1>
